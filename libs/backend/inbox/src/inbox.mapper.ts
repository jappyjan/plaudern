...
export function toInboxItemDto(entity: InboxItemEntity): InboxItemDto {
  return {
    ...
    // A user override takes precedence, without replacing the extractor's date.
    documentDate:
      entity.documentMetadata?.documentDateOverride ?? entity.documentMetadata?.documentDate ?? null,
