 ...
 * but the sidecar computes the whole transcription/diarization before sending
 ...
 *
 * ponytail: duplicated in libs/backend/speaker-id/src/providers — extract to a
 * shared lib if a third caller appears.
 */
